...
function start(){
    ...
    ff.sakusei.onclick=function(){
       var url='notice_input.jun';
       location.href=url;
    /* -------------------------------------------------------------------------- */
    }
    ff.btnFind.onclick=function(){
       ff.action="notice_list.jun";
       ff.submit();   
    }
}

function view(serial){
   var url = 'notice_view.jun';
   var ff = document.frm_board;
   ff.action = url;
...
<%String id = (String)session.getAttribute("id");
   if(id.equals("admin")||id.equals("manager")){      %>
      ...
      <div id='write'>
         <a id='input' href='pj_index.jsp?inc=../notice/notice_input.jsp'>  
