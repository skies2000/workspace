...
<h2 align='center'>${obj.subject }</h2><hr color="#83B14E"><br/>
  ...
  <label></label>
         <% 
    String id = (String)session.getAttribute("id");
    ABoardVo vo = (ABoardVo)request.getAttribute("obj");
    String worker = vo.getWorker();
    if(id.equals(worker)){
    %>   
       <input type='button' id='del' value='삭제' onclick="delButton()">
       <input type='button' value='수정' id='mod' onclick="modButton()">
    <%} %>
   ...
   <div id=inputworker>
     ...
     <div id=inputmdate>
      ...
      <a id='alink' href='#' id='freerepl_del' name='freerepl_del' onclick='repldel(${ob.serial})'>[삭제]</a></span></div>
      <br/>
   	<div id='inputcontent'>
