...
<script>
   function InputLateReport(){
      window.open('study_report_input_view.hwan','study_report','width=850px, height=950px');
      
   }
   function ViewStudyReport(serial){
      window.open('','study_report_view','width=850px, height=950px');
      var frm = document.frm_board;
      frm.serial.value=serial;
      frm.action ='study_report_view.jun';
      frm.target='study_report_view';
      frm.submit();   
   }
   function goPage(nowPage){
       var url = 'study_report_list.hwan';
   ...
   <!-- 작성버튼 -->      
      ...
      <form name='frm_board' method='post'>               
         ...
         <c:forEach var='obj' items='${list}'>
            ...
            <span class='subject'>
              <a href='#' onclick="ViewStudyReport('${obj.serial}')">${obj.studySb}</a>
            </span>
