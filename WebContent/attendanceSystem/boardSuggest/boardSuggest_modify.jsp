...
function start(){
	   ...
	   document.getElementById("btnView").onclick = function(){
	      url = "boardSuggestView.joo";
	      ff.action = url;
	      ff.submit();
	   }
	   document.getElementById("btnList").onclick = function(){
		     ff.enctype="";
	         url = "boardSuggestlist.joo";
	         ff.action = url;
	         ff.submit();
	   }
...
<form id='board_fonrm_1' method="post" action='boardSuggestModify.joo' enctype="multipart/form-data"><!-- action="sample.php"  -->
