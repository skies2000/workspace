...
<form id='board_fonrm_1' method="post" action='boardSuggestinsert.joo' enctype="multipart/form-data">
    <label>제목</label>
    <input type='text' name='subject' value='' size='60'/><br/><br/>
    <label>작성자</label>
    ...
    <div id='attfile'></div><br/>  
   <textarea name="content" id="ir1" rows="10" cols="100" style="width:600px; height:300px; display:none;"></textarea>
      <p>
